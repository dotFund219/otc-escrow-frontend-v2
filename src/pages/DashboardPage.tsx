      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        <div className="kpi">
          <div>
            ...
            <div className="text-4xl font-semibold mt-2 text-emerald-300">0</div>
          </div>
        </div>
        <div className="kpi">
          <div>
            <div className="muted text-sm">KYC Tier</div>
            <div className="text-4xl font-semibold mt-2">Tier 1</div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="panel p-6">
            ...
            <div className="mt-4 grid gap-2 text-sm">
              <div className="flex justify-between"><span className="muted">Role</span><span>TRADER</span></div>
              <div className="flex justify-between"><span className="muted">KYC Status</span><span className="pill border-emerald-400/30 bg-emerald-500/10 text-emerald-200">APPROVED</span></div>
              <div className="flex justify-between"><span className="muted">Member Since</span><span>2/13/2026</span></div>
            </div>
          </div>
        </div>
      </div>
